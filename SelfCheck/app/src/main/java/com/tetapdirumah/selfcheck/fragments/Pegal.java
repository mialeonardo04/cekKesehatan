...
public class Pegal extends Fragment implements ContractFragmentForm.View{
    ...
    void whenResume(){
        if (preferences != null){
            if (preferences.getString("pegal", "").equals("0")){
                changeSelectedColor(btn0);
            } else if (preferences.getString("pegal", "").equals("1")){
                changeSelectedColor(btn1);
            } else if (preferences.getString("pegal", "").equals("2")){
                changeSelectedColor(btn2);
            } else if (preferences.getString("pegal", "").equals("3")){
                changeSelectedColor(btn3);
            } else if (preferences.getString("pegal", "").equals("4")){
